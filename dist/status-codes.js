...
var _statusCodes = require('./statusCodes.json');

var _statusCodes2 = _interopRequireDefault(_statusCodes);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var informationalCodes = _statusCodes2.default.filter(function (statusObject) {
...
var actions = {
    getNewCode: function getNewCode() {
        return function (state) {
            var randomIndex = Math.floor(Math.random() * state.statuses.length);
...
//# sourceMappingURL=/dist/status-codes.map